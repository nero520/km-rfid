package com.msds.plugin.bank.b2babcBank;
...
/**
 * Plugin - 中国农业银行b2b网关支付
 * 
 * @author msdzsw.com
 * @version 3.0
 */
@Component("b2babcBankPlugin")
public class B2BABCBankPlugin extends PaymentPlugin {

	/** logger */
	private static final Logger logger = Logger
			.getLogger(B2BABCBankPlugin.class.getName());
	...
	public String getInstallUrl() {
		return "b2babcBank/install.html";
	}

	@Override
	public String getUninstallUrl() {
		return "b2babcBank/uninstall.html";
	}

	@Override
	public String getSettingUrl() {
		return "b2babcBank/setting.html";
	}
	...
	public Map<String, Object> getParameterMap(String sn, BigDecimal amount,
		...
		String merbank = "B2B_ABC";// 商户端所选支付银行当bankInput为0时，此字段只能为empty,在宝易互通上选择支付银行
	...
	public boolean verifyNotify(String sn, NotifyMethod notifyMethod,
		...
		logger.warning("中国农业银行b2b网关支付保卫互通数据：" + mac + ","
				+ merchantid.toString() + "," + merorderid.toString() + ","
				+ amountsum + "," + currencytype + "," + state.toString() + ","
				+ interFace);
		logger.warning("中国农业银行b2b网关支付数据：" + checkMac + ","
