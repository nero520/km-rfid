package com.msds.plugin.bank.pay99billBank;
...
public class Pay99billBankPlugin extends PaymentPlugin {
	...
	public String getInstallUrl() {
		return "pay_99bill_bank/install.html";
	}

	@Override
	public String getUninstallUrl() {
		return "pay_99bill_bank/uninstall.html";
	}

	@Override
	public String getSettingUrl() {
		return "pay_99bill_bank/setting.html";
	}
	...
	public Map<String, Object> getParameterMap(String sn, BigDecimal amount,
		...
		parameterMap
				.put("merchantAcctId", pluginConfig.getAttribute("partner"));
		...
		parameterMap.put("orderTimestamp", new SimpleDateFormat(
		...
		parameterMap.put("productDesc",
				StringUtils.abbreviate(description.replaceAll(
						"[^0-9a-zA-Z\\u4e00-\\u9fa5 ]", ""), 400));
		parameterMap.put("ext1", "msds_car");
		parameterMap.put("payType", "10");
		String bank = request.getParameter(BANK_PARAMETER_NAME);
		parameterMap.put("bankId", StringUtils.isNotEmpty(bank) ? bank
				: DEFAULT_BANK);
	...
	public boolean verifyNotify(String sn, NotifyMethod notifyMethod,
		...
		Map<String, Object> parameterMap = new LinkedHashMap<String, Object>();
		parameterMap.put("merchantAcctId",
				request.getParameter("merchantAcctId"));
		...
		// BigDecimal(request.getParameter("payAmount"))) == 0
		) {
			return true;
		}
		return false;
	...
	private String generateSign(Map<String, Object> parameterMap) {
		...
		return DigestUtils.md5Hex(
				joinKeyValue(parameterMap, null,
