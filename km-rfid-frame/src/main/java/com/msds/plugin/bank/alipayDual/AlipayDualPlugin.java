package com.msds.plugin.bank.alipayDual;
...
public class AlipayDualPlugin extends PaymentPlugin {
	...
	public String getInstallUrl() {
		return "alipay_dual/install.html";
	}

	@Override
	public String getUninstallUrl() {
		return "alipay_dual/uninstall.html";
	}

	@Override
	public String getSettingUrl() {
		return "alipay_dual/setting.html";
	}
	...
	public Map<String, Object> getParameterMap(String sn, BigDecimal amount,
		...
		parameterMap.put("price", amount.setScale(2, RoundingMode.HALF_UP)
				.toString());
	...
	public boolean verifyNotify(String sn, NotifyMethod notifyMethod,
		...
		if (generateSign(request.getParameterMap()).equals(
				...
				&& ("WAIT_SELLER_SEND_GOODS".equals(request
						.getParameter("trade_status"))
						|| "TRADE_SUCCESS".equals(request
								.getParameter("trade_status")) || "TRADE_FINISHED"
