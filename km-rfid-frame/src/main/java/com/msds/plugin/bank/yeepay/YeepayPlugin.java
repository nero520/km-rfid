package com.msds.plugin.bank.yeepay;
...
public class YeepayPlugin extends PaymentPlugin {
	...
	public String getInstallUrl() {
		return "yeepay/install.html";
	}

	@Override
	public String getUninstallUrl() {
		return "yeepay/uninstall.html";
	}

	@Override
	public String getSettingUrl() {
		return "yeepay/setting.html";
	}
	...
	public Map<String, Object> getParameterMap(String sn, BigDecimal amount,
		...
		parameterMap.put("p3_Amt", amount.setScale(2, RoundingMode.HALF_UP)
				.toString());
		parameterMap.put("p4_Cur", "CNY");
		parameterMap
				.put("p5_Pid", StringUtils.abbreviate(description.replaceAll(
						"[^0-9a-zA-Z\\u4e00-\\u9fa5 ]", ""), 20));
		parameterMap
				.put("p7_Pdesc", StringUtils.abbreviate(description.replaceAll(
						"[^0-9a-zA-Z\\u4e00-\\u9fa5 ]", ""), 20));
		parameterMap.put("p8_Url", getNotifyUrl(sn, NotifyMethod.general));
		parameterMap.put("p9_SAF", "0");
		parameterMap.put("pa_MP", "msds_car");
	...
	public boolean verifyNotify(String sn, NotifyMethod notifyMethod,
		...
		PluginConfig pluginConfig = getPluginConfig();
		Map<String, String[]> parameterValuesMap = WebUtils.getParameterMap(
				request.getQueryString(), "GBK");
		Map<String, Object> parameterMap = new LinkedHashMap<String, Object>();
	...
	public String getNotifyMessage(String sn, NotifyMethod notifyMethod,
			HttpServletRequest request) {
		if ("2".equals(WebUtils.getParameter(request.getQueryString(), "GBK",
				"r9_BType"))) {
			return "success";
		}
		return null;
	...
	private String generateSign(Map<String, Object> parameterMap) {
		PluginConfig pluginConfig = getPluginConfig();
		return hmacDigest(
				joinValue(parameterMap, null, null, null, false, "hmac"),
