package com.msds.plugin.bank.fudianBank;
 ...
 * @version 3.0
 */
@Component("fudianBankPlugin")
public class FUDIANBankPlugin extends PaymentPlugin {

	/** logger */
	private static final Logger logger = Logger
			.getLogger(FUDIANBankPlugin.class.getName());
	...
	public String getInstallUrl() {
		return "fudianBank/install.html";
	}

	@Override
	public String getUninstallUrl() {
		return "fudianBank/uninstall.html";
	}

	@Override
	public String getSettingUrl() {
		return "fudianBank/setting.html";
	}
	...
	public Map<String, Object> getParameterMap(String sn, BigDecimal amount,
		...
		String merbank = "FUDIAN";// 商户端所选支付银行当bankInput为0时，此字段只能为empty,在宝易互通上选择支付银行
	...
	public boolean verifyNotify(String sn, NotifyMethod notifyMethod,
		...
		logger.warning("富滇银行网关支付保卫互通数据：" + mac + "," + merchantid.toString()
				+ "," + merorderid.toString() + "," + amountsum + ","
				+ currencytype + "," + state.toString() + "," + interFace);
		logger.warning("富滇银行网关支付数据：" + checkMac + ","
