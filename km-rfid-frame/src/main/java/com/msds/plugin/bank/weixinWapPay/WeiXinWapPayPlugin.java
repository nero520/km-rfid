package com.msds.plugin.bank.weixinWapPay;
 ...
 * 微信支付
 * 
 * @ClassName WeiXinWapPayPlugin
 * @Description TODO
 * @author LiLong
 * @date 2015年07月16日 下午13:17:27
 * 
 */
@Component("weiXinWapPayPlugin")
public class WeiXinWapPayPlugin extends PaymentPlugin {
	...
	private String unifiedOrder(String sn, BigDecimal amountfee,
		...
		parameterMap.put("nonce_str", createNoncestr());
		 ...
		 parameterMap.put("openid", "onGjcs-wk7WI-DwfnygJPvjkCWh0");
		parameterMap
		...
		parameterMap.put("trade_type", "WAP");// 交易类型
