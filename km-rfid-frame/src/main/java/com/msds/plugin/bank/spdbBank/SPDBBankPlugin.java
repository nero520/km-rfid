package com.msds.plugin.bank.spdbBank;
 ...
 * @version 3.0
 */
@Component("spdbBankPlugin")
public class SPDBBankPlugin extends PaymentPlugin {

	/** logger */
	private static final Logger logger = Logger.getLogger(SPDBBankPlugin.class
			.getName());
	...
	public String getInstallUrl() {
		return "spdbBank/install.html";
	}

	@Override
	public String getUninstallUrl() {
		return "spdbBank/uninstall.html";
	}

	@Override
	public String getSettingUrl() {
		return "spdbBank/setting.html";
	}
	...
	public Map<String, Object> getParameterMap(String sn, BigDecimal amount,
		...
		String merbank = "SPDB";// 商户端所选支付银行当bankInput为0时，此字段只能为empty,在宝易互通上选择支付银行
