package com.msds.plugin.bank.heyihangGateway;
 ...
 * @version 3.0
 */
@Component("heyihangGatewayPlugin")
public class HeyihangGatewayPlugin extends PaymentPlugin {

	/** logger */
	private static final Logger logger = Logger
			.getLogger(HeyihangGatewayPlugin.class.getName());
	...
	public String getInstallUrl() {
		return "heyihangGateway/install.html";
	}

	@Override
	public String getUninstallUrl() {
		return "heyihangGateway/uninstall.html";
	}

	@Override
	public String getSettingUrl() {
		return "heyihangGateway/setting.html";
	}

	@Override
	public String getRequestUrl() {
		// return "http://60.247.27.65:38082/pay2_1_/paymentImplAction.do";
	...
	public boolean verifyNotify(String sn, NotifyMethod notifyMethod,
		...
		logger.warning("合一行网关支付保卫互通数据：" + mac + "," + merchantid.toString()
				+ "," + merorderid.toString() + "," + amountsum + ","
				+ currencytype + "," + state.toString() + "," + interFace);
		logger.warning("合一行网关支付数据：" + checkMac + ","
