package com.msds.plugin.bank.postBank;
 ...
 * @version 3.0
 */
@Component("postBankPlugin")
public class POSTBankPlugin extends PaymentPlugin {

	/** logger */
	private static final Logger logger = Logger.getLogger(POSTBankPlugin.class
			.getName());
	...
	public String getInstallUrl() {
		return "postBank/install.html";
	}

	@Override
	public String getUninstallUrl() {
		return "postBank/uninstall.html";
	}

	@Override
	public String getSettingUrl() {
		return "postBank/setting.html";
	}
	...
	public Map<String, Object> getParameterMap(String sn, BigDecimal amount,
		...
		String merbank = "POST";// 商户端所选支付银行当bankInput为0时，此字段只能为empty,在宝易互通上选择支付银行
