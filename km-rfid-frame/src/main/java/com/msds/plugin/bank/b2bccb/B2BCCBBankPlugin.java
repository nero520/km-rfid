package com.msds.plugin.bank.b2bccb;
...
/**
 * Plugin - 中国建设银行B2B网关支付
 * 
 * @author msdzsw.com
 * @version 3.0
 */
@Component("b2bccbBankPlugin")
public class B2BCCBBankPlugin extends PaymentPlugin {

	/** logger */
	private static final Logger logger = Logger
			.getLogger(B2BCCBBankPlugin.class.getName());
	...
	public String getInstallUrl() {
		return "b2bccbBank/install.html";
	}

	@Override
	public String getUninstallUrl() {
		return "b2bccbBank/uninstall.html";
	}

	@Override
	public String getSettingUrl() {
		return "b2bccbBank/setting.html";
	}
	...
	public Map<String, Object> getParameterMap(String sn, BigDecimal amount,
		...
		String merbank = "B2B_CCB";// 商户端所选支付银行当bankInput为0时，此字段只能为empty,在宝易互通上选择支付银行
	...
	public boolean verifyNotify(String sn, NotifyMethod notifyMethod,
		...
		logger.warning("中国建设银行B2B网关支付保卫互通数据：" + mac + ","
				+ merchantid.toString() + "," + merorderid.toString() + ","
				+ amountsum + "," + currencytype + "," + state.toString() + ","
				+ interFace);
		logger.warning("中国建设银行B2B网关支付数据：" + checkMac + ","
