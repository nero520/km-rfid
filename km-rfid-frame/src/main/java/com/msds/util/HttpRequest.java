...
public class HttpRequest {
	private final static Logger log = Logger.getLogger(HttpRequest.class);
	...
	public static class HttpClientFactory {
		...
		private HttpClientFactory() {
			...
			HttpConnectionManagerParams connectionManagerParams = connectionManager
					.getParams();
			...
			connectionManagerParams
					.setMaxTotalConnections(MAX_TOTAL_CONNECTIONS);
		}
	...
	public static void main(String[] args) {
		...
		// String url =
		// "http://42.159.232.19:9010/datasrv/1.0/erp/getGoodsStock";
		//
		// Params form = new Params();
		// form.setAccidList("015284");
		// form.setStoreidList("1007");
		//
		// Map<String, Object> params = new HashMap<String, Object>();
		// // params.put("businessCode", "1007");
		// params.put("params", form);
		// System.out.println(url);
		// String data = JsonUtils.toJson(form);
		// System.out.println(data);
		// // String reverse = httpUtil.post(url, params);
		// // System.out.println(reverse);
		//
		//
		// // //发送 GET 请求
		// // String s=HttpRequest.sendGet(url,
		// "businessCode=1009&params="+data);
