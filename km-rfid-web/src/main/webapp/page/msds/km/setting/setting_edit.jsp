		...
		<div id="editform" class="form">
			...
			<table style="width:100%;">
				<tr>
					<td>name：</td>
					<td><input name="name" 
						 vtype="rangeLength:1,50" style="width: 160px;"  class="mini-textbox" emptyText="请填写name" /></td>
				</tr>
				<tr>
					<td>value：</td>
					<td><input name="value" 
						 vtype="rangeLength:1,50" style="width: 160px;"  class="mini-textbox" emptyText="请填写value" /></td>
				</tr>
				<tr>
					<td>operater_id：</td>
					<td><input name="operaterId" 
						 vtype="rangeLength:1,50" style="width: 160px;"  class="mini-textbox" emptyText="请填写operater_id" /></td>
				</tr>
				<tr>
					<td>创建时间：</td>
...
<script type="text/javascript" src="<%=ctx%>/page/msds/km/setting/setting_edit.js"></script>
</html>