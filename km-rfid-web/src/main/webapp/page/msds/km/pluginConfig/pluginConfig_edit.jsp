	...
	<div class="mini-fit" style="background: url('<%=ctx%>/js/miniui/themes/blue/images/toolbar/toolbar.gif') repeat-x scroll 0 0 #f0f0f0;border: 1px solid #99bce8">
		<div id="editform" class="form">
			...
			<table style="width:100%;">
				...
				<tr>
					<td>是否启用：</td>
					<td><input name="isEnabled" 
						required="true" vtype="rangeLength:1,50" style="width: 160px;"  class="mini-textbox" emptyText="请填写是否启用" /></td>
				</tr>
				<tr>
					<td>插件id：</td>
					<td><input name="pluginId" 
...
<script type="text/javascript" src="<%=ctx%>/page/msds/km/pluginConfig/pluginConfig_edit.js"></script>
</html>