...
<body>
	<div class="mini-toolbar"
		...
		<table style="width:100%;">
			<tr>
				...
				data="[{'id':'id','text':'ID'},{'id':'itemName','text':'服务小项名称'},{'id':'price','text':'价格'},{'id':'operator','text':'操作人'},{'id':'createDate','text':'创建时间'},{'id':'modifyDate','text':'修改时间'}]" />
	...
	<div class="mini-fit">
		<div id="datagrid_laborcost" class="mini-datagrid"
			style="width:100%;height:100%;" borderStyle="border:0;"
			url="${ctx}/laborcost/dataList.action" idField="id"
			allowAlternating="true" sortField="id" sortOrder="desc"
			onrowdblclick="rowdblclick" multiSelect="true">
			<div property="columns">
				<div type="checkcolumn"></div>
					<div field="itemName"headerAlign="center" allowSort="true">服务小项名称</div>
...
<script type="text/javascript" src="<%=ctx%>/page/msds/km/laborcost/laborcost_list.js"></script>
</html>