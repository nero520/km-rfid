			...
			<table style="width:100%;">
				<tr>
					...
					<td><input name="itemName" 
						required="true" vtype="rangeLength:1,50" style="width: 160px;"  class="mini-textbox" emptyText="请填写服务小项名称" /></td>
				</tr>
				<tr>
					<td>价格：</td>
					<td><input name="price" 
						 allowLimitValue="false" style="width: 160px;"  class="mini-spinner" emptyText="请填写价格" /></td>
				</tr>
				<tr>
					<td>操作人：</td>
...
<script type="text/javascript" src="<%=ctx%>/page/msds/km/laborcost/laborcost_edit.js"></script>
</html>