	...
	<div class="mini-fit" style="background: url('<%=ctx%>/js/miniui/themes/blue/images/toolbar/toolbar.gif') repeat-x scroll 0 0 #f0f0f0;border: 1px solid #99bce8">
		<div id="editform" class="form">
			...
			<table style="width:100%;">
				<tr>
					<td>退货单编号：</td>
					<td><input name="returnSn" 
						 vtype="rangeLength:1,50" style="width: 160px;"  class="mini-textbox" emptyText="请填写退货单编号" /></td>
				</tr>
				<tr>
					<td>订单编号：</td>
				...
				<tr>
					<td>商品对象JSON：</td>
					<td><input name="productJson" 
						 vtype="rangeLength:1,50" style="width: 160px;"  class="mini-textbox" emptyText="请填写商品对象JSON" /></td>
				</tr>
				<tr>
					<td>直营店ID：</td>
					<td><input name="directShopId" 
						 vtype="rangeLength:1,50" style="width: 160px;"  class="mini-textbox" emptyText="请填写直营店ID" /></td>
				</tr>
				<tr>
					<td>修理厂ID：</td>
				...
				<tr>
					...
					<td><input name="status" 
						 vtype="rangeLength:1,50" style="width: 160px;"  class="mini-textbox" emptyText="请填写退货状态" /></td>
				</tr>
				<tr>
					<td>退货备注：</td>
					<td><input name="remark" 
						 vtype="rangeLength:1,50" style="width: 160px;"  class="mini-textbox" emptyText="请填写退货备注" /></td>
				</tr>
				<tr>
					<td>配件退货单号：</td>
					<td><input name="partsReturnSn" 
						 vtype="rangeLength:1,50" style="width: 160px;"  class="mini-textbox" emptyText="请填写配件退货单号" /></td>
				</tr>
				<tr>
					<td>操作人：</td>
...
<script type="text/javascript" src="<%=ctx%>/page/msds/km/return/return_edit.js"></script>
</html>