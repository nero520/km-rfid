...
public class RefundLogController extends BaseController{
	...
	public ModelAndView list(HttpServletRequest request) throws Exception{
		return forword("/km/refundLog/refundLog_list",null); 
	}
	...
	@ResponseBody
	public Object datalist(RefundLogEntity entity,HttpServletRequest request) throws Exception{
		List<RefundLogEntity> dataList = refundLogService.queryByList(entity);
	...
	@ResponseBody
	public Object save(@RequestBody RefundLogEntity entity, HttpServletRequest request) throws Exception{
		Date date = new Date();
		if(entity.getId()==null||StringUtils.isBlank(entity.getId().toString())){
			entity.setCreateDate(date);
			entity.setModifyDate(date);
			refundLogService.add(entity);
		}else{
			entity.setModifyDate(date);
			refundLogService.update(entity);
		}
	...
	public Object getId(String id,HttpServletRequest request) throws Exception{
		RefundLogEntity entity  = refundLogService.findById(id);
		if(entity  == null){
