 ...
 * 
 * <br>
 * <b>功能：</b>MemberModelController<br>
 * <b>作者：</b>lilong<br>
...
public class MemberModelController extends BaseController{
	...
	@Autowired
	private BespeakService bespService; 
	...
	public ModelAndView list(HttpServletRequest request) throws Exception{
		return forword("/km/memberModel/memberModel_list",null); 
	}
	...
	@ResponseBody
	public Object datalist(MemberModelEntity entity,HttpServletRequest request) throws Exception{
		List<MemberModelEntity> dataList = memberModelService.queryByList(entity);
	...
	@ResponseBody
	public Object save(@RequestBody MemberModelEntity entity, HttpServletRequest request) throws Exception{
		Date date = new Date();
		if(entity.getId()==null||StringUtils.isBlank(entity.getId().toString())){
			entity.setCreateDate(date);
			entity.setModifyDate(date);
			memberModelService.add(entity);
		}else{
			entity.setModifyDate(date);
			memberModelService.update(entity);
		}
	...
	public Object getId(String id,HttpServletRequest request) throws Exception{
		MemberModelEntity entity  = memberModelService.findById(id);
		if(entity  == null){
