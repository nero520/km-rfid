...
public class OrderLogController extends BaseController{
	...
	public ModelAndView list(HttpServletRequest request) throws Exception{
		return forword("/km/orderLog/orderLog_list",null); 
	}
	...
	@ResponseBody
	public Object datalist(OrderLogEntity entity,HttpServletRequest request) throws Exception{
		List<OrderLogEntity> dataList = orderLogService.queryByList(entity);
	...
	@ResponseBody
	public Object save(@RequestBody OrderLogEntity entity, HttpServletRequest request) throws Exception{
		Date date = new Date();
		if(entity.getId()==null||StringUtils.isBlank(entity.getId().toString())){
			entity.setCreateDate(date);
			entity.setModifyDate(date);
			orderLogService.add(entity);
		}else{
			entity.setModifyDate(date);
	...
	public Object getId(String id,HttpServletRequest request) throws Exception{
		OrderLogEntity entity  = orderLogService.findById(id);
		if(entity  == null){
