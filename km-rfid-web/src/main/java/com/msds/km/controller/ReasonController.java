...
public class ReasonController extends BaseController{
	...
	public ModelAndView list(HttpServletRequest request) throws Exception{
		return forword("/km/reason/reason_list",null); 
	}
	...
	@ResponseBody
	public Object datalist(ReasonEntity entity,HttpServletRequest request) throws Exception{
		List<ReasonEntity> dataList = reasonService.queryByList(entity);
	...
	@ResponseBody
	public Object save(@RequestBody ReasonEntity entity, HttpServletRequest request) throws Exception{
		Date date = new Date();
		if(entity.getId()==null||StringUtils.isBlank(entity.getId().toString())){
			entity.setCreateDate(date);
			entity.setModifyDate(date);
			reasonService.add(entity);
		}else{
			entity.setModifyDate(date);
	...
	public Object getId(String id,HttpServletRequest request) throws Exception{
		ReasonEntity entity  = reasonService.findById(id);
		if(entity  == null){
